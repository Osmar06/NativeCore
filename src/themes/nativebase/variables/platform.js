...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#007aff' : config.primaryColor,
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  fabIconColor: '#fff',
  fabIconSize: 24,
  fabShadowColor: config.darkColor,
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : config.primaryColor,
  ...
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : config.primaryColor,

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : config.primaryColor,
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : config.primaryColor,
  ...
  listItemSelected: platform === PLATFORM.IOS ? '#007aff' : config.primaryColor,
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#F8F8F8' : config.primaryColor,
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : config.primaryColor,
  segmentBorderColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : config.primaryColor,
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : config.primaryColor,
  ...
  titleFontColor: platform === PLATFORM.IOS ? config.darkColor : '#FFF',

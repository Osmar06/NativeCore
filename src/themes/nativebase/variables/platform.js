...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#007aff' : config.colors.primary,
  ...
  fabElevation: 4,
  fabIconColor: config.colors.white,
  fabIconSize: 24,
  fabShadowColor: config.colors.dark,
  ...
  footerHeight: 55,
  footerDefaultBg:
    platform === PLATFORM.IOS ? '#F8F8F8' : config.colors.primary,
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#b3c7f9',
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? '#007aff' : config.colors.white,
  sTabBarActiveTextColor: '#007aff',
  tabBarActiveTextColor:
    platform === PLATFORM.IOS ? '#007aff' : config.colors.white,
  tabActiveBgColor:
    platform === PLATFORM.IOS ? '#cde1f9' : config.colors.primary,

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : config.colors.white,
  toolbarDefaultBg:
    platform === PLATFORM.IOS ? '#F8F8F8' : config.colors.primary,
  toolbarHeight: platform === PLATFORM.IOS ? 64 : 56,
  toolbarSearchIconSize: platform === PLATFORM.IOS ? 20 : 23,
  toolbarInputColor:
    platform === PLATFORM.IOS ? '#CECDD2' : config.colors.white,
  searchBarHeight: platform === PLATFORM.IOS ? 30 : 40,
  searchBarInputHeight: platform === PLATFORM.IOS ? 30 : 50,
  toolbarBtnTextColor:
    platform === PLATFORM.IOS ? '#007aff' : config.colors.white,
  toolbarDefaultBorder:
    platform === PLATFORM.IOS ? '#a7a6ab' : config.colors.primary,
  ...
  listItemSelected:
    platform === PLATFORM.IOS ? '#007aff' : config.colors.primary,
  ...
  segmentActiveBackgroundColor:
    platform === PLATFORM.IOS ? '#007aff' : config.colors.white,
  segmentTextColor: platform === PLATFORM.IOS ? '#007aff' : config.colors.white,
  segmentActiveTextColor:
    platform === PLATFORM.IOS ? config.colors.white : config.colors.primary,
  segmentBorderColor:
    platform === PLATFORM.IOS ? '#007aff' : config.colors.white,
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : config.colors.primary,
  topTabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#b3c7f9',
  topTabBarActiveTextColor:
    platform === PLATFORM.IOS ? '#007aff' : config.colors.white,
  topTabBarBorderColor:
    platform === PLATFORM.IOS ? '#a7a6ab' : config.colors.white,
  ...
  subtitleColor: platform === PLATFORM.IOS ? '#8e8e93' : config.colors.white,
  titleFontColor:
    platform === PLATFORM.IOS ? config.colors.dark : config.colors.white,
